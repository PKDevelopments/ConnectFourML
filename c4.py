...
first_turn = input('Are you going first? Enter Y or N: ')

if first_turn == 'Y':
    while 1:
        player_input = int(input('What column will you play? Enter a value from 1-7     '))
        update_inputs(player_input,1)
